...
let CuestionariosService = class CuestionariosService extends generic_service_1.GenericService {
    constructor(cuestionariosRepository) {
        super(cuestionariosRepository);
        this.cuestionariosRepository = cuestionariosRepository;
    }
    async findByIdCuestionario(idCuestionario) {
        return this.cuestionariosRepository.find({ where: { id_cuestionario: idCuestionario } });
    }
};
CuestionariosService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(cuestionarios_entity_1.Cuestionarios)),
